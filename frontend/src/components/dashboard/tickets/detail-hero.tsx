        ...
        <div className="px-8 py-12 md:px-12 md:py-16 md:col-span-2">
          <div className="max-w-3xl">
            <div className="flex flex-wrap items-center gap-3 mb-6">
              <div
                className={`inline-flex capitalize items-center gap-2 rounded-full px-2 py-1 text-sm font-medium ${
        ...
        <div className="bg-white/80 backdrop-blur-sm p-6 m-6 rounded-xl shadow-md">
          ...
          <div className="mt-6 space-y-3 text-sm text-gray-700">
            ...
            <div className="flex items-center gap-2">
              ...
              Insurance Company: {ticket.customer.insuranceCompany || ""}
            </div>
            <div className="flex items-center gap-2">
              <Percent className="h-4 w-4 text-red-500" />
              Insurance Deductable: {ticket.customer.insuranceDeductable || ""}%
            </div>
            <div className="flex items-center gap-2">
              <Home className="h-4 w-4 text-red-500" />
              Roof Covered:{" "}
              {ticket.customer.isRoofCovered === true ? "Yes" : "No"}
            </div>
          </div>
        </div>
      </div>
