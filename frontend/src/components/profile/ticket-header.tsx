...
const TicketHeader = ({ ticket }: { ticket: ITicketById }) => {
  return (
    <section className="w-[90%] py-8 md:py-10 mx-auto">
      <div className="rounded-2xl bg-gradient-to-br from-blue-400 via-white to-cyan-400 border border-blue-100 shadow-lg">
        <div className="px-4 py-6 md:px-8 md:py-10 md:col-span-2">
